...
# Paths / Resume
config.output = "output/AdaDistill/"  # train model output folder
config.pretrained_teacher_path = "output/pretrained_model_ir50/146120backbone.pth"
config.pretrained_teacher_header_path = "output/pretrained_model_ir50/146120header.pth"  # teacher folder
